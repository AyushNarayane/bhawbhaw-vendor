  ...
  return (
    <div className="min-h-screen p-8">
      ...
      <div className="mb-8 flex justify-between items-center">
        ...
        {/* Search and Reload Icon */}
        <div className="flex space-x-2 items-center">
          <Input type="text" placeholder="Search" className="w-64 rounded-lg"
                      value={searchTerm}
        ...
        <Button
          className={`px-4 py-2 ${
            activeSection === "Add Product"
              ? "bg-[#695d56] text-white"
              : "border-[#695d56] border text-[#695d56]"
          }`}
          onClick={() => {
      ...
      {showProducts === "My Products" ? (
        <>
          <div className="flex space-x-4 mb-6">
            <Button
              className={`${
                productStatus === "approved" ? "bg-[#695d56] text-white" : ""
              } px-4 py-2`}
            ...
            <Button
              className={`${
                productStatus === "disabled" ? "bg-[#695d56] text-white" : ""
              } px-4 py-2`}
          ...
          <Table>
              <TableHeader>
                <TableRow className="border-b-2 border-[#C9ABA0]">
                  <TableHead className="text-[#C9ABA0] py-6">Title</TableHead>
                  <TableHead className="text-[#C9ABA0]">Category</TableHead>
                  <TableHead className="text-[#C9ABA0]">Subcategory</TableHead>
                  <TableHead className="text-[#C9ABA0]">SP</TableHead>
                  <TableHead className="text-[#C9ABA0]">MRP</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {filteredProducts.map((product) => (
                  <TableRow key={product.id} className="border-none">
                    ...
                    <TableCell className="pt-5">{product.category}</TableCell>
                    <TableCell className="pt-5">{product.subCategory}</TableCell>
                    <TableCell className="pt-5">{product.sellingPrice}</TableCell>
                    <TableCell className="pt-5">{product.maxRetailPrice}</TableCell>
                    <TableCell className="pt-5"> 
                      <button 
                        onClick={() => handleEdit(product)} 
                        className="bg-baw-baw-g3 text-white px-5 py-2 rounded"
                      >
                        Edit
                      </button>
                    </TableCell>
